...
<head>
    ...
    <style>
        #first,#second,#header,#main,#QrCode,#bottom{text-align: center;}
    </style>
</head>
<body>
    <div id="first">
        <input id="mer" placeholder="商户号" type="text">
        <input id="sig" placeholder="密钥" type="text">
    </div>
    <div id="second">
        <input id="return_url" placeholder="通知地址" type="text" style="width: 300px">
    </div>
    <div id="header">

...
<form name="form" method="post" action="http://120.25.96.46:8083/posp-settle/virtPay.do" target="_self">
    ...
    <input  type="hidden" name="accountName" value="<?php echo iconv('UTF-8','GBK//IGNORE',$_POST['accountName']); ?>" />
    <input  type="hidden" name="bankno" value="<?php echo $_POST['bankno']; ?>" />
    <input  type="hidden" name="mobile" value="<?php echo $_POST['mobile']; ?>" />
    <input  type="hidden" name="bankName" value="<?php echo iconv('UTF-8','GBK//IGNORE',$_POST['bankName']); ?>" />
    <input  type="hidden" name="bankType" value="<?php echo iconv('UTF-8','GBK//IGNORE',$_POST['bankType']); ?>" />
    <input  type="hidden" name="remark" value="<?php echo iconv('UTF-8','GBK//IGNORE',$_POST['remark']); ?>" />
